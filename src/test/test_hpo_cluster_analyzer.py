...
class TestHpoClusterAnalyzer(TestCase):
    ...
    @parameterized.expand([
        ...
        ['boolean_0_1_cov', 'cluster1', 3, False],
        ['boolean_0_1_cov', 'cluster2', 3, False],
        ['boolean_0_1_cov', 'cluster3', 3, False],
        ['boolean_0_1_cov', 'cluster4', 3, False],

        ['factor_cov_data', 'chi2', 200, False],
        ['factor_cov_data', 'p', 0, True],
        ['factor_cov_data', 'dof', 6, False],
        ['factor_cov_data', 'cluster1', 3, False],
        ['factor_cov_data', 'cluster2', 3, False],
        ['factor_cov_data', 'cluster3', 3, False],
        ['factor_cov_data', 'cluster4', 3, False],

        ['boolean_cov_not_signif', 'chi2', 0, False],
        ['boolean_cov_not_signif', 'p', 1, True],
        ['boolean_cov_not_signif', 'dof', 0, False],
        ['boolean_cov_not_signif', 'cluster1', 3, False],
        ['boolean_cov_not_signif', 'cluster2', 3, False],
        ['boolean_cov_not_signif', 'cluster3', 3, False],
        ['boolean_cov_not_signif', 'cluster4', 3, False],
        ...
        ['boolean_cov_low_n_data', 'cluster1', 3, False],
        ['boolean_cov_low_n_data', 'cluster2', 3, False],
        ['boolean_cov_low_n_data', 'cluster3', 3, False],
        ['boolean_cov_low_n_data', 'cluster4', 3, False],
    ])
